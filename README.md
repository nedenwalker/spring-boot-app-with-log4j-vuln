...
```console
spring-boot-app-with-log4j-vuln $ grype dir:.
...
grype docker.io/library/spring-boot-app-with-log4j-vuln:0.0.1-SNAPSHOT
```

## Sample Image Scan Results
```console
spring-boot-app-with-log4j-vuln $ grype docker.io/library/spring-boot-app-with-log4j-vuln:0.0.1-SNAPSHOT
 ✔ Vulnerability DB        [no update available]
 ✔ Loaded image
 ✔ Parsed image
